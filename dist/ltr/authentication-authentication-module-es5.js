  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["authentication-authentication-module"], {
        ...
        _createClass(SigninComponent, [{
          ...
          value: function onSubmit() {
            ...
            this.firestore.collection("userManagement", function (ref) {
              return ref.where("email", "==", _this.authForm.value.email).where("password", "==", _this.authForm.value.password);
            }).get().subscribe(function (ss) {
              if (ss.docs.length === 0) {
                _this.error = 'Email and Password Invalid !';
              } else {
    ...
    function umax(module, __webpack_exports__, __webpack_require__) {
      ...
      var SignupComponent = /*#__PURE__*/function () {
        function SignupComponent(formBuilder, route, router, authService, firestore) {
        ...
        _createClass(SignupComponent, [{
          ...
          value: function onSubmit() {
            ...
            this.firestore.collection("userManagement", function (ref) {
              return ref.where("email", "==", _this2.authForm.value.email);
            }).get().subscribe(function (ss) {
              if (ss.docs.length === 0) {
                _this2.firestore.collection("userManagement").add({
                  fullname: _this2.authForm.value.fullname,
                  username: _this2.authForm.value.username,
                  email: _this2.authForm.value.email,
                  password: _this2.authForm.value.password,
                  uniqueID: Math.random(),
                  status: "Disabled",
                  role: "User",
                  date: Object(_angular_common__WEBPACK_IMPORTED_MODULE_5__["formatDate"])(new Date(), "yyyy-MM-dd", "en")
                }).then(function (res) {
                  console.log(res); // this.authForm.reset();
      ...
      SignupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function SignupComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SignupComponent_Template_mat_icon_click_48_listener() {
              return ctx.hide = !ctx.hide;
            });
